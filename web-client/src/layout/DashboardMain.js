...
export function DashboardMain(){
    ...
    useEffect(() => {
        // Simulate checking if the user is logged in (0 means not logged in)
    ...
    return(
      <div className="flex">
         ...
         <div className="w-full h-screen flex flex-col">
                 <div className="w-full px-6 py-3 border-b-2">
                     <div className="flex items-center justify-between text-blue-gray-900">
                         ...
                         <Menu>
                             ...
                             <MenuList>
                                 ...
                                 <MenuItem className="flex items-center gap-2" onClick={handOn}>
                                     <svg
                                         width="16"
                                         height="14"
                                         viewBox="0 0 16 14"
